        ...
        .DataTable( {
            ...
            "aoColumns": [
                ...
                { data: null,
                    ...
                    {
                        return '<div class="btn-group"><a data-edit="'+item.id+'" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i></a><a data-delete="'+item.id+'" data-phone="'+item.phone+'" data-address="'+item.address+'" data-name="'+item.name+'" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a></div>' } },
